...
def initialize_agents():
    ...
    try:
        # Try to use the complex agents first, fall back to simple ones
        try:
            from agents.crew_agent import CrewAlumniAgent
            agents['crew'] = CrewAlumniAgent()
        except Exception:
            from agents.simple_agents import SimpleCrewAgent
            agents['crew'] = SimpleCrewAgent()
            st.info("Using simplified CrewAI agent")
    ...
    try:
        try:
            ...
            from agents.simple_agents import SimpleLangChainAgent
            agents['langchain'] = SimpleLangChainAgent()
            st.info("Using simplified LangChain agent")
    except Exception as e:
    ...
    try:
        try:
            ...
            from agents.simple_agents import SimpleLangGraphAgent
            agents['langgraph'] = SimpleLangGraphAgent()
            st.info("Using simplified LangGraph agent")
    except Exception as e:
    ...
    try:
        try:
            ...
            from agents.simple_agents import SimpleAutoGenAgent
            agents['autogen'] = SimpleAutoGenAgent()
            st.info("Using simplified AutoGen agent")
    except Exception as e:
